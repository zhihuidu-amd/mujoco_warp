...
def step(m: Model, d: Data):
  ...
  """
  # AMD PR#6: No adaptive hipGraph in step() — mjlab handles graph capture externally.
  # mjlab sim.py creates CUDA graphs via create_graph() which captures mjwarp.step()
